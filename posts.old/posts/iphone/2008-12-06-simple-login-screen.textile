...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content">
          ...
          <div class="two-col">
            <div class="text-blob">
  <h2 style="color: #2E8AD1;">iPhone Simple Login Screen</h2>
  <div style="font-size: .7em; color: #bbb;">06 Dec 2008</div>
