...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content">
          ...
          <div class="two-col">
            <div class="text-blob">
  <h2 style="color: #2E8AD1;">BlackBerry UI</h2>
...
<div class="text-blob">
  <div>
    <div style="float: right;">
      ...
      <a href="/posts.old/posts/iphone/2008-11-27-sad-state-mobile" title="My interest in mobile platforms lately has turned to disappointment. I'm quickly realizing that mobile technologies are in a state of disarray, and far more nascent than the commercials on TV would have you believe. Very little is ready for primetime, which is a huge headache for developers and users alike.">The Sad State of Mobile &raquo; </a>
      
    </div>
    
    <div>
      
      <a href="/posts.old/posts/blackberry/2008-11-27-blackberry-persistent-store" title="Simple code snippet showing a static class that wraps around an encrypted persistent store. Acts as a key/val retrieval system, but persists to disk underneath.">&laquo; BlackBerry Persistent Store</a>
