...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content">
          ...
          <div class="two-col">
            <div class="text-blob">
  <h2 style="color: #2E8AD1;">BlackBerry Persistent Store</h2>
...
<div class="text-blob">
  <div>
    <div style="float: right;">
      ...
      <a href="/posts.old/posts/blackberry/2008-11-27-blackberry-ui" title="Basic notes on adding a button, and calling pushscreen.">BlackBerry UI &raquo; </a>
      
    </div>
    
    <div>
      
      <a href="/posts.old/posts/blackberry/2008-11-27-blackberry-http-client" title="HTTPClient is a small class that gets web content from a URL for the BlackBerry.">&laquo; BlackBerry HTTP Client</a>
