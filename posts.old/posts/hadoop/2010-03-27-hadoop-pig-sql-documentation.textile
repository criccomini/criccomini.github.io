...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content">
          ...
          <div class="two-col">
            <div class="text-blob">
  <h2 style="color: #2E8AD1;">Hadoop, Pig, and SQL</h2>
  <div style="font-size: .7em; color: #bbb;">27 Mar 2010</div>
...
<div class="text-blob">
  <div>
    <div style="float: right;">
      ...
      <a href="/posts.old/posts/linux/2012-09-25-kill-subprocesses-linux-bash" title="A common requirement when writing Bash scripts in Linux is to kill all a process and all of its child that were spawned. This tutorial describes various methods to prevent orphaned subprocesses.">Killing Subprocesses in Linux/Bash &raquo; </a>
      
    </div>
    
    <div>
      
      <a href="/posts.old/posts/blackberry/2010-03-22-blackberry-storm-gps" title="This example outlines how to get GPS working on a real BlackBerry Storm using Verizon Wireless with GPS and data services enabled.">&laquo; BlackBerry Storm GPS</a>
