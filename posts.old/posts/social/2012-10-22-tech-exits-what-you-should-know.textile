...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content">
          ...
          <div class="two-col">
            <div class="text-blob">
  <h2 style="color: #2E8AD1;">Tech Exits: What You Should Know</h2>
  <div style="font-size: .7em; color: #bbb;">22 Oct 2012</div>
...
<div class="text-blob">
  <div>
    <div style="float: right;">
      ...
      <a href="/posts.old/posts/hadoop/2013-06-14-yarn-with-cgroups" title="One of YARN's exciting new features is its support for Cgroups in YARN containers. This post shows how to setup and use Cgroups with YARN 2.0.5-alpha.">Using YARN with Cgroups &raquo; </a>
      
    </div>
    
    <div>
      
      <a href="/posts.old/posts/hadoop/2012-10-12-hortonworks-yarn-meetup" title="On Friday, I presented, "Building Applications on YARN," at the Apache YARN meet-up at Hortonworks. This post contains my slides, as well as notes about the meet-up.">&laquo; Hortonworks YARN Developer Meetup Notes (October '12)</a>
